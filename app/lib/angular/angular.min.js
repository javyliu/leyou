...
b.nodeName:b[0].nodeName};var qc=/[A-Z]/g,md={full:"1.1.5-5a8ae94",major:1,minor:1,dot:5,codeName:"triangle-squarification"},Ja=O.cache={},Ia=O.expando="ng-"+(new Date).getTime(),uc=1,ec=M.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,a,c){b.attachEvent("on"+a,c)},fb=M.document.removeEventListener?function(b,a,c){b.removeEventListener(a,c,!1)}:function(b,a,c){b.detachEvent("on"+a,c)},sc=/([\:\-\_]+(.))/g,tc=/^moz([A-Z])/,Aa=O.prototype={ready:function(b){function a(){c||
